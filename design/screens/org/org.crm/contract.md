...
secondary_actions:
  - "Open a lead/family record (LIVE both halves: /leads/[leadId] and — per ADR-109 — /families/[familyId] with household contacts and the family's leads; notes and stage history stay recorded gaps until doc 28 §2's Activity object exists — business data only)"
