...
## 12. Sources (linked)
[Noto API reference](https://app.withnoto.com/api/docs) · [Noto OpenAPI 3.1 spec](https://app.withnoto.com/api-docs/openapi.json) (fetched Aug 20, 2026 — studied for patterns, no schemas reproduced) · [Stripe API conventions](https://docs.stripe.com/api) (idempotency, prefixed IDs, versioning, expand — prior art) · [RFC 9457 Problem Details](https://www.rfc-editor.org/rfc/rfc9457) · [1EdTech](https://www.1edtech.org/) (LTI 1.3 / LTI Advantage / OneRoster — pin exact spec versions from here at the implementing PR) · [Clever](https://www.clever.com/) · [ClassLink](https://www.classlink.com/) · Pack docs 07/10/11/12 for the machinery this API derives from.