...
## 7. Sources
Noto integrations page (fetched) · Teachworks integrations pages, blog, Capterra/GetApp listings · TutorCruncher integrations page + Zoom/Xero help docs, toolradar review · Kaltura/spotSaaS/Koala Go/Tutorbase 2026 virtual-classroom comparisons · Truto MCP 2026 guides, ayautomate MCP analysis, Advisable MCP strategy, first-person ChatGPT-Apps/Claude-connector submission writeup. All studied for patterns; no copy reproduced.
