...
| tutor.resources | tutor | app, org | n/a | n/a (web sidebar item) | n/a (struck) | Resources (doc 36 §3.3 web sidebar) | Open a resource | none (struck) | STRUCK | Struck 2026-09-02 per its contract's own condition — no content pipeline exists; rail item never rendered, contract kept as the record |
