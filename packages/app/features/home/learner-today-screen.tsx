...
// student home whose top card is the next skill the model picks (doc 36 §3.1).
// It says "next" rather than "resume" because no resume pointer exists — see
// design/screens/learner/learner.home/contract.md, primary_action note.
// Band-adaptive, not role-conditional: both branches are the same child's
// shell, so this is the §2-legal kind of switch.
