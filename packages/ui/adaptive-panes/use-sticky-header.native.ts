'use client';
// PLATFORM FORK — native: the UI-thread auto-hiding header. Web's fork is a
// static header — see use-sticky-header.web.ts for the trade.
// SOT: ./sticky-header.ts (the pure math) · ./README.md
// SOT-KEYWORDS: sticky header native reanimated scroll retract fork
