'use client';
// Mobbin: https://mobbin.com/screens/c8082986-1895-4bc5-9e2e-86401f4a415a (LangChain —
//   search field scoped to the list pane, above the rows it filters) ·
//   https://mobbin.com/screens/beafa73d-3c43-4ddc-9949-b0b1c2f76d12 (Threads —
//   per-pane search that never leaks into the detail column). Structure only.
// SOT: ./pane-search.ts (back priority) · ./README.md
// SOT-KEYWORDS: pane search bar debounce draft query composed
