'use client';
// PLATFORM FORK — native: the touch gesture. The web fork is static — see
// SwipeableRow.web.tsx for the trade.
// Mobbin: https://mobbin.com/screens/9dae9f31-b569-44e1-948b-5dcae49c1e7a (Zillow —
//   inbox rows with per-row actions, list beside detail) ·
//   https://mobbin.com/screens/beafa73d-3c43-4ddc-9949-b0b1c2f76d12 (Threads —
//   message rows driving a detail pane). Structure only.
// SOT: ./swipe-actions.ts · ./README.md
// SOT-KEYWORDS: swipeable row native gesture reanimated commit park fork
