// The 16:10 promise, and the two ways a layout silently breaks it.
//
...
// SOT-KEYWORDS: board layout test aspect ratio 16:10 landscape rail chat overlap constrained
...
test('the writable surface is 16:10 across every space that fits it', () => {
  const cases = [
    { ...spatial, R: 0.12 },
