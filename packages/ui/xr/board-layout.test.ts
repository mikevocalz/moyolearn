// The 6:4 promise, and the two ways a layout silently breaks it.
//
...
// SOT-KEYWORDS: board layout test aspect ratio 6:4 landscape rail chat overlap constrained
...
test('the writable surface is 6:4 across every space that fits it', () => {
  const cases = [
    { ...spatial, R: 0.12 },
