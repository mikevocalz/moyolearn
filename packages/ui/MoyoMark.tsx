...
import Svg, { Path, Polygon, type SvgProps } from "react-native-svg";
...
/*
  ...
  SOT-KEYWORDS: logo mark emblem glyph brand moyo icon favicon compact svg native
*/
...
// Explicit dimensions, in lockstep with the web fork so one mark is one size on
// both platforms.
...
export interface MoyoMarkProps extends Omit<SvgProps, "width" | "height"> {
  variant?: LogoVariant;
...
const MoyoMark = ({ variant = "default", style, width, height, ...props }: MoyoMarkProps) => (
  <Svg
    {...props}
