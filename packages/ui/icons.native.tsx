...
export const Lock = icon(L.Lock as React.ComponentType<object>, 'Lock');
...
export const OctagonAlert = icon(L.OctagonAlert as React.ComponentType<object>, 'OctagonAlert');
export const WifiOff = icon(L.WifiOff as React.ComponentType<object>, 'WifiOff');
...
export const ChevronUp = icon(L.ChevronUp as React.ComponentType<object>, 'ChevronUp');
