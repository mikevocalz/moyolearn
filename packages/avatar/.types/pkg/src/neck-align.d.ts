...
export declare const NECK_ALIGN_FROM = "gnm-model";
export declare const NECK_ALIGN_TO = "smplx-headbone-local(gltf-y-up)";
/**
 ...
 */
export declare function assertNeckAlign(doc: NeckAlign, identitySha256: string): void;
/**
 ...
 */
export declare function loadNeckAlign(url: string, identitySha256: string): Promise<NeckAlign>;
