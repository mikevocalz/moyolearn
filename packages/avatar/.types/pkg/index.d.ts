...
export { createFaceBus, type ConversationCues, type FaceBus, type FaceBusOptions, } from './src/face-bus.ts';
export { claimNeckFrame, claimNeckWriter } from './src/neck-writer.ts';
export { claimFaceWriter, avatarStore } from './src/store.ts';
export { DEFAULT_MINIMUM_PRESENCE_MS, createTutorStage, shouldRender3D, showsProgress, type SettleReason, type StagePhase, type StageState, type Surface, type TutorStage, type TutorStageOptions, } from './src/tutor-stage.ts';
export { CALM_IDLE, DEFAULT_GESTURE_LIMITS, DEFAULT_RIG_SEMANTICS, FORBIDDEN_GESTURES, PERMITTED_GESTURES, assertNoEngagementPressure, assertRigSemantics, gateGestureTrack, isPermittedGesture, type ForbiddenGesture, type GateResult, type GestureFunction, type GestureLimits, type IdlePolicy, type PermittedGesture, type RigSemantics, type Violation, type ViolationKind, } from './src/safety/gesture-gate.ts';
export { ANIMATED_SURFACES, MOTION_POLICIES, applyMotionPolicy, assertMotionPolicyComplete, motionPolicy, resolveMotionMode, type AnimatedSurface, type MotionConsumers, type MotionInputs, type MotionMode, type MotionPolicy, type MotionSurface, } from './src/reduced-motion.ts';
